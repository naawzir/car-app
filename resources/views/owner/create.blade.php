            ...
            <div class="col-md-8">
                ...
                <div class="card">
                    ...
                    <div id="car-form" class="card-body">
                        <form method="POST" action="/cars/create" enctype="multipart/form-data" @submit.prevent="onSubmit" @keydown="form.errors.clear($event.target.name)">
                            @csrf
                            <h3>@{{ carDetails }}</h3>
                            <div class="form-group row">
                                <label for="make" class="col-md-4 col-form-label text-md-right">Make</label>

                                <div class="col-md-6">
                                    <input id="make" type="text" class="form-control" name="make" value="{{ old('make') }}" v-model="form.make" {{--required--}} autofocus>
                            ...
                            {{--<div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input type="file" class="form-control" id="image" name="image" v-model="form.image">
                                    <span class="text-danger font-weight-bold" v-if="form.errors.has('image')" v-text="form.errors.get('image')"></span>
                                </div>
                            </div>--}}
